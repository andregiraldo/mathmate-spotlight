            ...
            <CarouselContent>
              {discounts.map((discount) => (
                <CarouselItem key={discount.id} className="md:basis-1/2 lg:basis-1/3 p-2">
                  <Card className="overflow-hidden border-none shadow-lg h-full rounded-2xl transition-all duration-300 hover:-translate-y-2 hover:shadow-xl bg-background/10">
                    <div className="relative p-6 text-white rounded-t-2xl bg-gray-900/50">
